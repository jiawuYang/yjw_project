 ...
 */
static inline void __list_add(list_head_t *newitem,
    list_head_t *prev,
    list_head_t *next)
{
    next->prev = newitem;
 ...
 */
static inline void list_add(list_head_t *newitem, list_head_t *head)
{
 ...
 */
static inline void list_add_tail(list_head_t *newitem, list_head_t *head)
{
...
static inline void __list_splice(list_head_t *list,
    list_head_t *head)
{
 ...
 * @pos:	the &list_head_t to use as a loop counter.
